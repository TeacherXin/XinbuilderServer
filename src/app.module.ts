...
import { TalkRecordModule } from './server/talk-record/talk-record.module';


const DBRootModule = MongooseModule.forRoot('mongodb://127.0.0.1/localData');
@Module({
  imports: [DBRootModule,pageJsonModal, UploadModule,LgoinModal,EntityModal, TalkRecordModule],
